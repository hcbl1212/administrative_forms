...
RSpec.feature "Employees", type: :feature do
    ...
    scenario "Create a new Employee and System Access Request with default role sales rep", js: true do
        visit "/employees/new"
        ...
        saf = SystemAccessField.find_by_name('Sales Rep Portal (Email required) SAS').id
        find("label[for=employee_system_access_requests_attributes_0_system_access_field_ids_#{saf}]").click
        ...
        expect(employee.sales_rep?).to equal(true)
